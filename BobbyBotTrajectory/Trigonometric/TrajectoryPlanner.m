classdef TrajectoryPlanner < handle
    ...
    methods
        function obj=TrajectoryPlanner(varargin)
            ...
            obj.curve = CurvePlanner('R',R,'dR',dR,'n',n,'xi',xi);
        ...
        function plot_xy(obj)
            plot(obj.trajectory(:,1),obj.trajectory(:,2),'LineWidth',2);
        end
        function plot_vw(obj)
            plot(obj.trajectory(:,4),'LineWidth',2);
            hold on;
            plot(obj.trajectory(:,5),'LineWidth',2);
        end
    end
end
