classdef CurvePlanner < handle
    ...
    methods
        ...
        function [x,y]=xy(obj,t)  
            ...
            y = 0;
            if t>=0 && t<=2*pi
                x = obj.dir*(obj.R+obj.dR*cos(obj.xi+obj.n*t))*sin(t);
        ...
        function [x_dot,y_dot]=xy_dot(obj,t)  
            ...
            y_dot = 0;
            if t>=0 && t<=2*pi
                x_dot = obj.dir*(cos(t)*(obj.R + obj.dR*cos(obj.xi+obj.n*t)) - obj.dR*obj.n*sin(obj.xi+obj.n*t)*sin(t));
        ...
        function [x_dot_dot,y_dot_dot]=xy_dot_dot(obj,t)  
            ...
            y_dot_dot = 0;
            if t>=0 && t<=2*pi
                x_dot_dot = obj.dir*(- sin(t)*(obj.R + obj.dR*cos(obj.xi+obj.n*t)) - obj.dR*obj.n^2*cos(obj.xi+obj.n*t)*sin(t) - 2*obj.dR*obj.n*sin(obj.xi+obj.n*t)*cos(t));
...
%                 y_dot_dot = 2*obj.dR*obj.n*sin(obj.xi+obj.n*t)*sin(t) - obj.dR*obj.n^2*cos(obj.xi+obj.n*t)*cos(t) - cos(t)*(obj.R + obj.dR*cos(obj.xi+obj.n*t));
        ...
        function [x_dot_dot_dot,y_dot_dot_dot]=xy_dot_dot_dot(obj,t)  
            ...
            y_dot_dot_dot = 0;
            if t>=0 && t<2*pi
                x_dot_dot_dot = obj.dir*(obj.dR*obj.n^3*sin(obj.xi + obj.n*t)*sin(t) - cos(t)*(obj.R + obj.dR*cos(obj.xi + obj.n*t)) + 3*obj.dR*obj.n*sin(obj.xi + obj.n*t)*sin(t) - 3*obj.dR*obj.n^2*cos(obj.xi + obj.n*t)*cos(t));
